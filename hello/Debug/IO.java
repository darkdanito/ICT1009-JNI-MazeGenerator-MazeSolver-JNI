...
public class IO 
{
	...
	{														// Read maze from text file
		// Update the location of the Maze File below: 
		String fileName = "C:\\Users\\darkdanito\\Desktop\\D3 GUI\\hello\\Debug\\test.txt";
	...
	public static void Save (MazeGenerator newMaze) 
	{
		...
		try {
		    writer = new BufferedWriter(new OutputStreamWriter(
		          new FileOutputStream(("C:\\Users\\darkdanito\\Desktop\\D3 GUI\\hello\\Debug\\javaTest.txt"), false)));
	...
	public static void NecroSave (char player, char moveType, int xPos, int yPos) 
	{
		...
		{
		    writer = new BufferedWriter(new OutputStreamWriter(
		          new FileOutputStream(("C:\\Users\\darkdanito\\Desktop\\D3 GUI\\hello\\Debug\\necroTest.txt"), true)));
